...
public class StaticndReturn {

	public static void main(String[] args) {

		char ch[][] = {{'a','b','c'},{'x','y','z'},{'i','j','k'}};
		char r[] = assignment1.reverse2Dchar(ch);
		...
		System.out.println("String Concat : "+assignment1.concatchar(r));
		System.out.println();
		//-------------------------------------------------------------------------

		char r1[] = assignment1.firstrow(ch);
		...
		char r5[] =  assignment1.alpha2ndhalf();
		...
		char r6[] =  assignment1.reversealpha();
		...
		int sum =  assignment1.sumprime();
		System.out.print("Sum: " + sum);
		System.out.println("");
		System.out.println("");
		//------------------------------------------------------------------------------

		int c =  assignment1.countprime();
		...
		int x1[] =  assignment1.divisibleby5();
		...
		String s1[] = assignment1.firsthalf(str);
		...
		int br = assignment1.booleantrue(b);
		for(int i = 0;i<br;i++)
		{
